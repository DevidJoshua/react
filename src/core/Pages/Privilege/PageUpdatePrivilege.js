...
const FormUpdate = (props) => {
  ...
  }, [tablepaginationResetForm, tablepaginationOnChangeForm, upsertServiceName, id, roleId])
  return (
    <div className='row'>
      <div className='col-sm-6'>
        ...
        <div className='form-group'>
          ...
          <input type='text' placeholder='page, field, sectioncontent, main menu' className='form-control' value={typeof payload.entity !== 'undefined' ? payload.entity : dataDetail.entity || ''} onChange={e => tablepaginationOnChangeForm({ serviceName: upsertServiceName, fieldName: 'entity', fieldValue: e.target.value })} />
        </div>
        <div className='form-group'>
