  ...
  return (
    <>
      <dl>
        ...
        <dt>role</dt>
        <dd>{(dataDetail.role_id || []).map(i => i.title).join(',')}</dd>
      ...
      <div className='row'>
        <div className='col-md-12'>
          <Detail
            ...
            fields='_id,title,name,description,entity,created_at,updated_at,created_by{full_name},updated_by{full_name},role_id{title}'
